              ...
              <form id="formClient">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input readonly value="<?php echo $record['dni']; ?>" type="number" name="inputDNI" class="form-control" id="inputDNI" placeholder="Only numbers">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input value="<?php echo $record['credit_card']; ?>" type="number" name="inputCreditCard" class="form-control" id="inputCreditCard" placeholder="No dashes or spaces">
                  </div>
                </div>
                <!-- /.card-body -->
