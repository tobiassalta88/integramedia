              ...
              <form id="formClient">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="inputDNI" class="form-control" id="inputDNI" placeholder="Only numbers">
                  </div>
                  <div class="form-group">
                    <label for="inputBirthday">Birthday:</label>
                    <div class="input-group date" data-target-input="nearest">
                        <input id="inputBirthday" name="inputBirthday" onchange="updateAge(this.value)" type="text" class="form-control datetimepicker-input" data-target="#inputBirthday" onkeydown="return false"/>
                  ...
                  <div class="form-group">
                    ...
                    <input id="inputAge" class="form-control" type="text" placeholder="Age" readonly>
                  </div>
                  <div class="form-group">
                    <label for="inputCreditCard">Credit Card:</label>
                    <input type="number" name="inputCreditCard" class="form-control" id="inputCreditCard" placeholder="No dashes or spaces">
                  </div>
                </div>
                <!-- /.card-body -->
                <div class="card-footer">
                  <a href="../clients.php" class="btn btn-default" role="button" aria-pressed="true">Cancel</a>
