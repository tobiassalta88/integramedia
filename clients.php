    ...
    <section class="content">
      ...
      <div class="container-fluid">
        <div class="card card-default">
          <div class="card-body">
            <a href="client/new.php" class="btn btn-info float-right" role="button" aria-pressed="true">
                  ...
                  <tr>
                      ...
                      <td>
                        <?php
                          $id = $row['id'];
                         ?>
                        <a href="client/edit.php?i=<?php echo $id ?>" class="btn btn-sm btn-success" role="button" aria-pressed="true">
                          <i class="nav-icon fas fa-edit"></i>
                        </a>
                        <button onclick="deleteClient('<?php echo $id ?>')" type="button" name="button" class="btn btn-sm btn-danger">
