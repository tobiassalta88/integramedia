    ...
    <section class="content">
      ...
      <div class="container-fluid">
        <div class="card card-default">
          <div class="card-body">
            <a href="employee/new.php" class="btn btn-info float-right" role="button" aria-pressed="true">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                      ...
                      <?php
                      $birth_year = date("Y",strtotime($row['birthday']));
                      $birth_month = date("m",strtotime($row['birthday']));
                      $birth_day = date("d",strtotime($row['birthday']));
                      ...
                      <td>
                        <?php
                          $id = $row['id'];
                         ?>
                        <a href="employee/edit.php?i=<?php echo $id ?>" class="btn btn-sm btn-success" role="button" aria-pressed="true">
                          <i class="nav-icon fas fa-edit"></i>
                        </a>
                        <button onclick="deleteEmployee('<?php echo $id ?>')" type="button" name="button" class="btn btn-sm btn-danger">
