              ...
              <form id="formProduct">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inputBrand" name="inputBrand" placeholder="Brand">
                  </div>
                  <div class="form-group">
                    <label for="inputPrice">Price:</label>
                    <input type="number" class="form-control" id="inputPrice" name="inputPrice" placeholder="Brand">
                  </div>
                  <div class="form-group">
                    <label for="inputProvider">Provider:</label>
                    <select id="inputProvider" class="form-control select2" style="height: 100%;">
                    ...
                    <div class="form-group mt-3">
                      ...
                      <div class="input-group date" data-target-input="nearest">
                          <input id="inputExpirationDate" name="inputExpirationDate" type="text" class="form-control datetimepicker-input" data-target="#inputBirthday" onkeydown="return false"/>
