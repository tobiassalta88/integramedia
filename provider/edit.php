  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">EDIT PROVIDER</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <form id="formProvider">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input value="<?php echo $record['direction']; ?>" type="text" class="form-control" id="inputDirection" name="inputDirection" placeholder="Direction">
                  </div>
                  <div class="form-group">
                    <label for="inputPhone">Phone:</label>
                    <input value="<?php echo $record['phone']; ?>" type="number" name="inputPhone" class="form-control" id="inputPhone" placeholder="Only numbers">
                  </div>
                </div>
                <!-- /.card-body -->
                <div class="card-footer">
                  <a href="../providers.php" class="btn btn-default" role="button" aria-pressed="true">Cancel</a>
