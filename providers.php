  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">PROVIDER LIST</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Provider List</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="container-fluid">
        <div class="card card-default">
          <div class="card-body">
            <a href="provider/new.php" class="btn btn-info float-right" role="button" aria-pressed="true">
                  ...
                  <tr>
                      ...
                      <td>
                        <?php
                          $id = $row['id'];
                         ?>
                        <a href="provider/edit.php?i=<?php echo $id ?>" class="btn btn-sm btn-success" role="button" aria-pressed="true">
                          <i class="nav-icon fas fa-edit"></i>
                        </a>
                        <button onclick="deleteProvider('<?php echo $id ?>')" type="button" name="button" class="btn btn-sm btn-danger">
